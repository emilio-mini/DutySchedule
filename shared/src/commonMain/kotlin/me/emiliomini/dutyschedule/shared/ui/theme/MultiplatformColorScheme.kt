...
/**
 * Returns the appropriate [ColorScheme] for the given [darkTheme] and [dynamicColor] flags.
 * On Android 12+, when [dynamicColor] is true, wallpaper-derived colors are used.
 * On other platforms or when [dynamicColor] is false, the static branded color scheme is used.
 */
