...
val TruckSpeed: ImageVector
    get() {
        if (_TruckSpeed != null) return _TruckSpeed!!

        _TruckSpeed = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveQuadTo(69f, 640f)
                quadToRelative(0f, -17f, 11.5f, -28.5f)
                reflectiveQuadTo(109f, 600f)
                ...
                close()
                moveToRelative(-99f, 73f)
                lineToRelative(6.5f, -29f)
                quadToRelative(6.5f, -29f, 16.5f, -71f)
                quadToRelative(3f, -13f, 6f, -24f)
                reflectiveQuadToRelative(5f, -22f)
                lineToRelative(6.5f, -29f)
                quadToRelative(6.5f, -29f, 16.5f, -71f)
                reflectiveQuadToRelative(16.5f, -71f)
                lineToRelative(6.5f, -29f)
                ...
                moveTo(70f, 533f)
                quadToRelative(-17f, 0f, -28.5f, -11.5f)
                reflectiveQuadTo(30f, 493f)
                quadToRelative(0f, -17f, 11.5f, -28.5f)
                reflectiveQuadTo(70f, 453f)
                horizontalLineToRelative(140f)
                quadToRelative(17f, 0f, 28.5f, 11.5f)
                reflectiveQuadTo(250f, 493f)
                quadToRelative(0f, 17f, -11.5f, 28.5f)
                reflectiveQuadTo(210f, 533f)
                horizontalLineTo(70f)
                close()
                moveToRelative(80f, -146f)
                quadToRelative(-17f, 0f, -28.5f, -11.5f)
                reflectiveQuadTo(110f, 347f)
                quadToRelative(0f, -17f, 11.5f, -28.5f)
                reflectiveQuadTo(150f, 307f)
                horizontalLineToRelative(180f)
                quadToRelative(17f, 0f, 28.5f, 11.5f)
                reflectiveQuadTo(370f, 347f)
                quadToRelative(0f, 17f, -11.5f, 28.5f)
                reflectiveQuadTo(330f, 387f)
                horizontalLineTo(150f)
                close()
                moveToRelative(130f, 333f)
                quadToRelative(17f, 0f, 28.5f, -11.5f)
...
private var _TruckSpeed: ImageVector? = null